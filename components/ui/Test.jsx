    ...
    <Canvas gl={{ antialias: false }} dpr={[1, 1.5]}>
      <Suspense fallback={null}>
        <ScrollControls infinite horizontal damping={4} pages={4} distance={1}>
          ...
          {/* </Scroll> */}
          <Scroll html>
            <h1 style={{ position: 'absolute', top: '20vh', left: '-50vw' }}>other</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '50vw' }}>details</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '125vw' }}>go</h1>
            <h1 style={{ position: 'absolute', top: '20vh', left: '225vw' }}>here</h1>
